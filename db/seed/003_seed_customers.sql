...
VALUES
  ('Customer One', 'active', 'Addis Ababa', 'Addis Ababa', 'Bole', '+251911000004', 'customer1@b2b.local', TRUE, NOW(), NOW(), FALSE),
  ('Customer Two', 'active', 'Addis Ababa', 'Addis Ababa', 'Kirkos', '+251911000005', 'customer2@b2b.local', TRUE, NOW(), NOW(), FALSE),
