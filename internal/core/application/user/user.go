...
var (
	...
	ErrEmailNotFound         = errors.New("¯\\_(ツ)_/¯, email not found")
	ErrPhoneNotFound         = errors.New("¯\\_(ツ)_/¯, phone not found")
	ErrUsernameNotFound      = errors.New("¯\\_(ツ)_/¯, username not found")
	ErrActiveStatusNotFound  = errors.New("¯\\_(ツ)_/¯, active_status not found")
	ErrFirstNameMandatory    = errors.New("¯\\_(ツ)_/¯, FirstName not supplied")
	ErrLastNameMandatory     = errors.New("¯\\_(ツ)_/¯, LastName not supplied")
	ErrUsernameMandatory     = errors.New("¯\\_(ツ)_/¯, Username not supplied")
	ErrPhoneOrEmailMandatory = errors.New("¯\\_(ツ)_/¯, phone or email mandatory")
	ErrEmptyGetContent       = errors.New("¯\\_(ツ)_/¯, content is empty")
	ErrUserAlreadyActive     = errors.New("¯\\_(ツ)_/¯, user already active")
	ErrUserAlreadyInactive   = errors.New("¯\\_(ツ)_/¯, user already inactive")
	ErrRoleDoesNotExist      = errors.New("¯\\_(ツ)_/¯, role does not exist")
	ErrRoleNotAssigned       = errors.New("¯\\_(ツ)_/¯, role not assigned")
	ErrRoleAlreadyAssigned   = errors.New("¯\\_(ツ)_/¯, role already assigned")
	ErrNoRoleAssigned        = errors.New("¯\\_(ツ)_/¯, no roles assigned")
	ErrResourceDoesNotExist  = errors.New("¯\\_(ツ)_/¯, resource does not exist")
	ErrUnknown               = errors.New("¯\\_(ツ)_/¯, unknown error")
	ErrPhoneNotValid         = errors.New("¯\\_(ツ)_/¯, phone number not valid")
	ErrEmailNotValid         = errors.New("¯\\_(ツ)_/¯, email not valid")
	ErrEmailTaken            = errors.New("¯\\_(ツ)_/¯, email already taken")
	ErrUserNameTaken         = errors.New("¯\\_(ツ)_/¯, username already taken")
	ErrPasswordMandatory     = errors.New("¯\\_(ツ)_/¯, password not supplied")
)
