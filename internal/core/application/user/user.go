...
var (
	...
	ErrEmailNotFound         = errors.New("¯\\_(o_o)_/¯, email not found")
	ErrPhoneNotFound         = errors.New("¯\\_(o_o)_/¯, phone not found")
	ErrUsernameNotFound      = errors.New("¯\\_(o_o)_/¯, username not found")
	ErrActiveStatusNotFound  = errors.New("¯\\_(o_o)_/¯, active_status not found")
	ErrFirstNameMandatory    = errors.New("¯\\_(o_o)_/¯, FirstName not supplied")
	ErrLastNameMandatory     = errors.New("¯\\_(o_o)_/¯, LastName not supplied")
	ErrUsernameMandatory     = errors.New("¯\\_(o_o)_/¯, Username not supplied")
	ErrPhoneOrEmailMandatory = errors.New("¯\\_(o_o)_/¯, phone or email mandatory")
	ErrEmptyGetContent       = errors.New("¯\\_(o_o)_/¯, content is empty")
	ErrUserAlreadyActive     = errors.New("¯\\_(o_o)_/¯, user already active")
	ErrUserAlreadyInactive   = errors.New("¯\\_(o_o)_/¯, user already inactive")
	ErrRoleDoesNotExist      = errors.New("¯\\_(o_o)_/¯, role does not exist")
	ErrRoleNotAssigned       = errors.New("¯\\_(o_o)_/¯, role not assigned")
	ErrRoleAlreadyAssigned   = errors.New("¯\\_(o_o)_/¯, role already assigned")
	ErrNoRoleAssigned        = errors.New("¯\\_(o_o)_/¯, no roles assigned")
	ErrResourceDoesNotExist  = errors.New("¯\\_(o_o)_/¯, resource does not exist")
	ErrUnknown               = errors.New("¯\\_(o_o)_/¯, unknown error")
	ErrPhoneNotValid         = errors.New("¯\\_(o_o)_/¯, phone number not valid")
	ErrEmailNotValid         = errors.New("¯\\_(o_o)_/¯, email not valid")
	ErrEmailTaken            = errors.New("¯\\_(o_o)_/¯, email already taken")
	ErrUserNameTaken         = errors.New("¯\\_(o_o)_/¯, username already taken")
	ErrPasswordMandatory     = errors.New("¯\\_(o_o)_/¯, password not supplied")
)
