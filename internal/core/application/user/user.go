...
var (
	...
	ErrActiveStatusNotFound  = errors.New(" active_status not found")
	ErrFirstNameMandatory    = errors.New(" FirstName not supplied")
	ErrLastNameMandatory     = errors.New(" LastName not supplied")
	ErrUsernameMandatory     = errors.New(" Username not supplied")
	ErrPhoneOrEmailMandatory = errors.New(" phone or email mandatory")
	ErrEmptyGetContent       = errors.New(" content is empty")
	...
	ErrNoRoleAssigned        = errors.New(" no roles assigned")
	...
	ErrPasswordMandatory     = errors.New(" password not supplied")
)
