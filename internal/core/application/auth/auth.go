...
var (
	...
	ErrFailedToLogin        = errors.New("¯\\_(•_•)_/¯, email or password incorrect")
	ErrUnknown              = errors.New("¯\\_(•_•)_/¯, unknown error has occured")
	ErrEmailNotSupplied     = errors.New("¯\\_(•_•)_/¯, email mandatory")
	ErrUsernameNotSupplied  = errors.New("¯\\_(•_•)_/¯, username mandatory")
	ErrInvalidEmail         = errors.New("¯\\_(•_•)_/¯, invalid Email")
	ErrPasswordNotSupplied  = errors.New("¯\\_(•_•)_/¯, password mandatory")
	ErrFirstNameNotSupplied = errors.New("¯\\_(•_•)_/¯, firstname mandatory")
	ErrLastNameNotSupplied  = errors.New("¯\\_(•_•)_/¯, lastname mandatory")
	ErrTokenNotSupplied     = errors.New("¯\\_(•_•)_/¯, token is mandatory")
	ErrTokenHasExpired      = errors.New("¯\\_(•_•)_/¯, token has expired")
	ErrUserIdNotSupplied    = errors.New("¯\\_(•_•)_/¯, userId mandatory")
	ErrFailedToDecodeToken  = errors.New("¯\\_(•_•)_/¯, failed to decode token")
)
