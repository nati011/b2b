...
var (
	ErrEmptyGetContent                                        = errors.New("¯\\_(ツ)_/¯, no product found")
	ErrAlreadyActive                                          = errors.New("¯\\_(ツ)_/¯, product already active")
	ErrAlreadyInactive                                        = errors.New("¯\\_(ツ)_/¯, product already inactive")
	ErrIdNotFound                                             = errors.New("¯\\_(ツ)_/¯, id not found")
	ErrNameNotSupplied                                        = errors.New("¯\\_(ツ)_/¯, name is not supplied")
	ErrDescNotSupplied                                        = errors.New("¯\\_(ツ)_/¯, description is not supplied")
	ErrNameDuplicate                                          = errors.New("¯\\_(ツ)_/¯, name duplicate")
	ErrImagesMustBeAtleastTwo                                 = errors.New("¯\\_(ツ)_/¯, images must be atleast two")
	ErrPriceNotSupplied                                       = errors.New("¯\\_(ツ)_/¯, price is not supplied")
	ErrAttributeValuesCannotBeEmpty                           = errors.New("¯\\_(ツ)_/¯, attribute values cannot be empty")
	ErrUnknown                                                = errors.New("¯\\_(ツ)_/¯, unkown error")
	ErrCategoryNotFound                                       = errors.New("¯\\_(ツ)_/¯, category not found")
	ErrPriceCannotBeNegative                                  = errors.New("¯\\_(ツ)_/¯, price cannot be negative")
