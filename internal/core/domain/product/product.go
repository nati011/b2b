...
var (
	ErrEmptyGetContent                                        = errors.New("¯\\_(•_•)_/¯, no product found")
	ErrAlreadyActive                                          = errors.New("¯\\_(•_•)_/¯, product already active")
	ErrAlreadyInactive                                        = errors.New("¯\\_(•_•)_/¯, product already inactive")
	ErrIdNotFound                                             = errors.New("¯\\_(•_•)_/¯, id not found")
	ErrNameNotSupplied                                        = errors.New("¯\\_(•_•)_/¯, name is not supplied")
	ErrDescNotSupplied                                        = errors.New("¯\\_(•_•)_/¯, description is not supplied")
	ErrNameDuplicate                                          = errors.New("¯\\_(•_•)_/¯, name duplicate")
	ErrImagesMustBeAtleastTwo                                 = errors.New("¯\\_(•_•)_/¯, images must be atleast two")
	ErrPriceNotSupplied                                       = errors.New("¯\\_(•_•)_/¯, price is not supplied")
	ErrAttributeValuesCannotBeEmpty                           = errors.New("¯\\_(•_•)_/¯, attribute values cannot be empty")
	ErrUnknown                                                = errors.New("¯\\_(•_•)_/¯, unkown error")
	ErrCategoryNotFound                                       = errors.New("¯\\_(•_•)_/¯, category not found")
	ErrPriceCannotBeNegative                                  = errors.New("¯\\_(•_•)_/¯, price cannot be negative")
	ErrStockUnavailable                                       = errors.New("¯\\_(•_•)_/¯, requested quantity greater than stock")
	ErrStockReservationQtyMustBeLessThanOrEqualToAvailableQty = errors.New("¯\\_(•_•)_/¯, reserved quantity cannot be more than available quantity")
	ErrFreeReservationQtyMustBeLessThanOrEqualToReservedQty   = errors.New("¯\\_(•_•)_/¯, free reservation quantity cannot be more than reserved quantity")
	ErrDistributorNotFound                                    = errors.New("¯\\_(•_•)_/¯, distributor not found")
	ErrDistributorIdMandatory                                 = errors.New("¯\\_(•_•)_/¯, distributor id not supplied")
)
