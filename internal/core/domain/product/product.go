...
var (
	ErrEmptyGetContent                                        = errors.New("¯\\_(o_o)_/¯, no product found")
	ErrAlreadyActive                                          = errors.New("¯\\_(o_o)_/¯, product already active")
	ErrAlreadyInactive                                        = errors.New("¯\\_(o_o)_/¯, product already inactive")
	ErrIdNotFound                                             = errors.New("¯\\_(o_o)_/¯, id not found")
	ErrNameNotSupplied                                        = errors.New("¯\\_(o_o)_/¯, name is not supplied")
	ErrDescNotSupplied                                        = errors.New("¯\\_(o_o)_/¯, description is not supplied")
	ErrNameDuplicate                                          = errors.New("¯\\_(o_o)_/¯, name duplicate")
	ErrImagesMustBeAtleastTwo                                 = errors.New("¯\\_(o_o)_/¯, images must be atleast two")
	ErrPriceNotSupplied                                       = errors.New("¯\\_(o_o)_/¯, price is not supplied")
	ErrAttributeValuesCannotBeEmpty                           = errors.New("¯\\_(o_o)_/¯, attribute values cannot be empty")
	ErrUnknown                                                = errors.New("¯\\_(o_o)_/¯, unkown error")
	ErrCategoryNotFound                                       = errors.New("¯\\_(o_o)_/¯, category not found")
	ErrPriceCannotBeNegative                                  = errors.New("¯\\_(o_o)_/¯, price cannot be negative")
	ErrStockUnavailable                                       = errors.New("¯\\_(o_o)_/¯, requested quantity greater than stock")
	ErrStockReservationQtyMustBeLessThanOrEqualToAvailableQty = errors.New("¯\\_(o_o)_/¯, reserved quantity cannot be more than available quantity")
	ErrFreeReservationQtyMustBeLessThanOrEqualToReservedQty   = errors.New("¯\\_(o_o)_/¯, free reservation quantity cannot be more than reserved quantity")
	ErrDistributorNotFound                                    = errors.New("¯\\_(o_o)_/¯, distributor not found")
	ErrDistributorIdMandatory                                 = errors.New("¯\\_(o_o)_/¯, distributor id not supplied")
)
