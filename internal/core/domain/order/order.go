...
var (
	...
	ErrRetailerIdNotSupplied              = errors.New("¯\\_(•_•)_/¯, retailer id mandatory")
	ErrRetailerIdNotFound                 = errors.New("¯\\_(•_•)_/¯, retailer does not exist")
	ErrAtleastOneOrderItemNeeded          = errors.New("¯\\_(•_•)_/¯, order items cannot be empty")
	ErrItemMemberProductIdOrQuantityEmpty = errors.New("¯\\_(•_•)_/¯, either order item member productId or quantity missing")
	ErrUnknown                            = errors.New("¯\\_(•_•)_/¯, unknown error")
	ErrEmptyGetResponse                   = errors.New("¯\\_(•_•)_/¯, empty get response")
	ErrAlreadyCanceled                    = errors.New("¯\\_(•_•)_/¯, order already canceled")
	ErrItemMemberProductNotFound          = errors.New("¯\\_(•_•)_/¯, product not found")
	ErrItemMemberProductQuantityNotFound  = errors.New("¯\\_(•_•)_/¯, product quantity not found")
	ErrDuplicateOrderNotAllowed           = errors.New("¯\\_(•_•)_/¯, duplicate order not allowed")
	ErrOrderAlreadyConfirmed              = errors.New("¯\\_(•_•)_/¯, order already confirmed")
	ErrOrderAlreadyRejected               = errors.New("¯\\_(•_•)_/¯, order already rejected")
)
