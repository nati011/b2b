...
var (
	...
	ErrRetailerIdNotSupplied              = errors.New("¯\\_(o_o)_/¯, retailer id mandatory")
	ErrRetailerIdNotFound                 = errors.New("¯\\_(o_o)_/¯, retailer does not exist")
	ErrAtleastOneOrderItemNeeded          = errors.New("¯\\_(o_o)_/¯, order items cannot be empty")
	ErrItemMemberProductIdOrQuantityEmpty = errors.New("¯\\_(o_o)_/¯, either order item member productId or quantity missing")
	ErrUnknown                            = errors.New("¯\\_(o_o)_/¯, unknown error")
	ErrEmptyGetResponse                   = errors.New("¯\\_(o_o)_/¯, empty get response")
	ErrAlreadyCanceled                    = errors.New("¯\\_(o_o)_/¯, order already canceled")
	ErrItemMemberProductNotFound          = errors.New("¯\\_(o_o)_/¯, product not found")
	ErrItemMemberProductQuantityNotFound  = errors.New("¯\\_(o_o)_/¯, product quantity not found")
	ErrDuplicateOrderNotAllowed           = errors.New("¯\\_(o_o)_/¯, duplicate order not allowed")
	ErrOrderAlreadyConfirmed              = errors.New("¯\\_(o_o)_/¯, order already confirmed")
	ErrOrderAlreadyRejected               = errors.New("¯\\_(o_o)_/¯, order already rejected")
)
