...
var (
	...
	ErrNameDuplicate                    = errors.New(" name already in use")
	...
	ErrImagesMustBeAtleastTwo           = errors.New(" atleast two images mandatory")
	ErrAttributeKeysMustBeAtleastOne    = errors.New(" atleast one attribute key mandatory")
	ErrProductsMustBeAtleastOne         = errors.New(" atleast product mandatory")
	ErrAlreadyAvailable                 = errors.New(" product already available")
	ErrAlreadyUnavailable               = errors.New(" product already unavailable")
	ErrIdNotFound                       = errors.New(" id not found")
	ErrProductNotFound                  = errors.New(" product not found")
	ErrAttributeKeysDoNotExistInProduct = errors.New(" attributes not found in products")
)
