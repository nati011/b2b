...
var (
	...
	ErrNameDuplicate                    = errors.New("¯\\_(•_•)_/¯, name already in use")
	ErrEmptyGetContent                  = errors.New("¯\\_(•_•)_/¯, empty get content")
	ErrUnknown                          = errors.New("¯\\_(•_•)_/¯, error unknown")
	ErrDescIsNotSupplied                = errors.New("¯\\_(•_•)_/¯, desc is mandatory")
	ErrImagesMustBeAtleastTwo           = errors.New("¯\\_(•_•)_/¯, atleast two images mandatory")
	ErrAttributeKeysMustBeAtleastOne    = errors.New("¯\\_(•_•)_/¯, atleast one attribute key mandatory")
	ErrProductsMustBeAtleastOne         = errors.New("¯\\_(•_•)_/¯, atleast product mandatory")
	ErrAlreadyAvailable                 = errors.New("¯\\_(•_•)_/¯, product already available")
	ErrAlreadyUnavailable               = errors.New("¯\\_(•_•)_/¯, product already unavailable")
	ErrIdNotFound                       = errors.New("¯\\_(•_•)_/¯, id not found")
	ErrProductNotFound                  = errors.New("¯\\_(•_•)_/¯, product not found")
	ErrAttributeKeysDoNotExistInProduct = errors.New("¯\\_(•_•)_/¯, attributes not found in products")
)
