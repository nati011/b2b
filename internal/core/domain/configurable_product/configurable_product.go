...
var (
	...
	ErrNameDuplicate                    = errors.New("¯\\_(ツ)_/¯, name already in use")
	ErrEmptyGetContent                  = errors.New("¯\\_(ツ)_/¯, empty get content")
	ErrUnknown                          = errors.New("¯\\_(ツ)_/¯, error unknown")
	ErrDescIsNotSupplied                = errors.New("¯\\_(ツ)_/¯, desc is mandatory")
	ErrImagesMustBeAtleastTwo           = errors.New("¯\\_(ツ)_/¯, atleast two images mandatory")
	ErrAttributeKeysMustBeAtleastOne    = errors.New("¯\\_(ツ)_/¯, atleast one attribute key mandatory")
	ErrProductsMustBeAtleastOne         = errors.New("¯\\_(ツ)_/¯, atleast product mandatory")
	ErrAlreadyAvailable                 = errors.New("¯\\_(ツ)_/¯, product already available")
	ErrAlreadyUnavailable               = errors.New("¯\\_(ツ)_/¯, product already unavailable")
	ErrIdNotFound                       = errors.New("¯\\_(ツ)_/¯, id not found")
	ErrProductNotFound                  = errors.New("¯\\_(ツ)_/¯, product not found")
	ErrAttributeKeysDoNotExistInProduct = errors.New("¯\\_(ツ)_/¯, attributes not found in products")
)
