...
var (
	...
	ErrCannotProceedWithPaymentPartner = errors.New("¯\\_(o_o)_/¯, cannot proceed with payment partner")
	ErrCannotConfirmDigitalPayment     = errors.New("¯\\_(o_o)_/¯, cannot cofirm digital payment")
)
