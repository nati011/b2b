...
var (
	ErrInvalidRequestBody = errors.New("¯\\_(•_•)_/¯, invalid request data")
	ErrFailedToAuthorize  = errors.New("¯\\_(•_•)_/¯, failed to authorize user")
	ErrIdRequired         = errors.New("¯\\_(•_•)_/¯, Id is required")
)
