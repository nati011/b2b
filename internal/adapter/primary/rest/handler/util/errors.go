...
var (
	ErrInvalidRequestBody = errors.New("¯\\_(o_o)_/¯, invalid request data")
	ErrFailedToAuthorize  = errors.New("¯\\_(o_o)_/¯, failed to authorize user")
	ErrIdRequired         = errors.New("¯\\_(o_o)_/¯, Id is required")
)
