...
export default function Hero() {
  return (
    <section className="w-full min-h-[calc(100dvh-5rem)] max-h-[calc(100dvh-5rem)] relative bg-gradient-to-b from-gray-50 via-white to-white overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col min-h-0">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 flex-1 flex flex-col justify-center">
        ...
        {/* Mobile App Banner */}
        <div className="w-full flex-shrink-0 bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 border-t border-b border-primary/20 mt-4">
