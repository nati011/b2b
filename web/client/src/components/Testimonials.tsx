    ...
    const testimonials: Testimonial[] = [
        {
            ...
            content: "Efoyeta's wholesale platform has transformed our inventory management. Their curated collections consistently outperform other suppliers, and the analytics dashboard gives us valuable insights for better purchasing decisions.",
            rating: 5,
        ...
        },
        {
            ...
            content: "Since partnering with Efoyeta two years ago, our average basket size has increased by 28%. The quality of their products and reliability of their supply chain has made them our go-to wholesale partner.",
            rating: 5,
        ...
        },
        {
            ...
            content: "The flexible minimum order quantities and seasonal discounts have allowed us to experiment with new product categories with minimal risk. Their account management team provides exceptional support.",
            rating: 4,
        ...
        <section className="py-16 container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {testimonials.map(testimonial => (
                    <div key={testimonial.id} className="bg-secondary/20 p-6 rounded-lg border">
