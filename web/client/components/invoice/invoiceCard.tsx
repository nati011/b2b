...
// @ts-ignore
export const InvoiceCard: React.FC<Props> = ({ loading, invoice }) => {
  return (
    <div className="gap-4 print:w-full important">
      <Card className="rounded-sm px-4 shadow-none mx-auto max-w-6xl">
            ...
            <div className="flex">
              ...
              <div className="font-light sm:text-md text-sm text-neutral-700 ml-2">
                <span className="dark:text-white">
                  {new Date(invoice.Created_Date).toDateString()}
                </span>
              </div>
            </div>
          </div>
