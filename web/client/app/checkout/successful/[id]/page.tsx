...
const ThankYou = () => {
    ...
    const orderId = 'ORD-' + routeParam.id;
    ...
    useEffect(() => {
        const verify = async () => {
            try {
                const verifyStatus = await paymentVerification();
            } catch (error) {
            }
        };
                        ...
                        verified ? (
                            <>
                                ...
                                <Card className="mb-8 border-green-200 bg-green-50 shadow-none rounded-sm print:hidden">
                                    <CardContent className="p-6 text-center">
                                        ...
                                        <h1 className="text-3xl font-bold text-green-800 mb-2">Thank You for Your Purchase!</h1>
                            ...
                            <>
                                <div className="w-full flex flex-col gap-6 items-center justify-center text-center py-20">
                                    <Image src={'/failed-payment.png'} width={300} height={400} alt="failed transaction" />
                                    <div>
