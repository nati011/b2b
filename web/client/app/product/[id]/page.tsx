...
const ProductDetail = () => {
    ...
    const [currentPrice, setCurrentPrice] = useState(catalogue!.configurables[0].price);
            ...
            <main className='container mx-auto px-4 pt-24 pb-16'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center'>
                            ...
                            {catalogue?.images.map((image, index) => (
                                <div className="" key={index}>
                                    <img
                                        ...
                                        src={image.ImageUrl}
                                        alt={catalogue.name}
                                        className={`max-w-xs object-cover hover:border-2 hover:border-gray-900 hover:shadow-md hover:shadow-gray-400 rounded-md ${selectedImage?.ImageUrl == image.ImageUrl ? 'ring-2 ring-black border-black '
                    ...
                    <div className='flex flex-col'>
                        ...
                        <p className='text-xl text-primary mb-4'>${currentPrice}</p>
