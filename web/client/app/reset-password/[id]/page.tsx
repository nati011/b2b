...
export default function LoginPage() {
    ...
    const callbackUrl = searchParams.get("token") || "/"
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="password" type="password" placeholder='********' required value={password} onChange={(e) => setPassword(e.target.value)} onBlur={(e) => {
                                    if (!e.target.value) {
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input className={`${errors.confirmPassword ? 'ring-red-300' : ''}`} id="confirm-password" type="password" placeholder='********' required onChange={(e) => setConfirmPassword(e.target.value)} value={confirmPassword} onBlur={(e) => {
                                    if (!e.target.value) {
