                            ...
                            <div className="text-center py-16 bg-white rounded-lg border border-gray-100">
                                <div className="w-24 h-24 mx-auto mb-6 bg-gray-100 rounded-full flex items-center justify-center">
                                    <svg className="w-12 h-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l-2.5 5m4.5 0h9" />
                                    </svg>
                                </div>
                                ...
                                <div className="lg:col-span-2">
                                    <div className="bg-white rounded-lg border border-gray-100 p-6 sticky top-8">
                                        ...
                                        <div className="space-y-3 mb-4">
                                            ...
                                            <div className="flex justify-between text-sm">
                                                <span className="font-medium">Delivery Estimation: </span>
                ...
                <DialogContent className="sm:max-w-2xl">
                    ...
                    <div className="py-4">
                        {loading && partners.length === 0 ? (
                            ...
                            <div className={`grid sm:grid-cols-${partners.length} grid-cols-2  gap-4`}>
                                {partners.map((partner) => (
                                    <Card
                                        key={partner.id}
                                        className={`cursor-pointer transition-all hover:shadow-md ${selectedPartner.id === partner.id
                                            ? 'ring-2 ring-blue-500 border-blue-500 bg-blue-50'
                                            : 'border-gray-200 hover:border-gray-300'
                                            }`}
                                        onClick={() => setSelectedPartner({ id: partner.id, name: partner.name, payment_method: partner.payment_method })}
                                    >
                    ...
                    >
                        {checkoutLoading ? (
                            ...
                            `Continue ${selectedPartner.name ? `with ${selectedPartner.name}` : ''}`
                        )}
                    </Button>
                </DialogContent>
            </Dialog>
